# Generated by Django 2.1b1 on 2018-07-17 08:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkedevice', '网络设备'), ('storagedevice', '储存设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
                ...
                ('purchase_day', models.DateTimeField(blank=True, null=True, verbose_name='购买日期')),
                ...
                ('memo', models.TimeField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star_day', models.DateTimeField(blank=True, null=True, verbose_name='开始日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_core_count', models.PositiveIntegerField(default=1, verbose_name='CPU核数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot', models.CharField(blank=True, max_length=64, null=True, verbose_name='所在插槽')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128, verbose_name='时间名称')),
                ('event_type', models.SmallIntegerField(choices=[(0, '其他'), (1, '硬件变更'), (2, '新增设备'), (3, '设备下线'), (4, '设备上线'), (5, '定期维护'), (6, '业务上线\\更新\\变更')], default=4, verbose_name='事件类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True, verbose_name='产商名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_detail', models.TimeField(blank=True, null=True, verbose_name='详细配置')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '网络设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '防火墙'), (1, '入侵检查设备'), (2, '互联网网关'), (4, '运维审计系统')], default=0, verbose_name='安全设备类型')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '安全设备',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, 'PC 服务器'), (1, '刀片机'), (2, '小型机')], default=0, verbose_name='服务器类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '操作系统'), (1, '办公\\开发软件'), (2, '软件业务')], default=0, verbose_name='软件类型')),
                ('license_num', models.IntegerField(default=1, verbose_name='授权数量')),
                ('version', models.CharField(help_text='例如：Cents release 6.7 （Final）', max_length=64, unique=True, verbose_name='软件/系统版本')),
            ],
            options={
                'verbose_name': '软件/系统',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '磁盘阵列'), (1, '网络储存器'), (2, '磁带库'), (4, '磁带机')], default=0, verbose_name='储存设备类型')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '储存设备',
